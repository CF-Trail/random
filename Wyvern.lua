-- I AM NOT THE ORIGINAL OWNER NOR I KNOW WHO IS IT
-- PLEASE DM @szze ON DISCORD TO BE CREDITED HERE
--<3
...
task.spawn(
    function()
        ...
        local win =
            discord:Window("Wyvern " .. getgenv().wyvern_version .. " - redblues edition [DylanElHacker = Femboy]")
        ...
        if getgenv().WyvernConfig["Change Log"] then
            ...
            changelog:Label("Join https://[Log in to view URL] for newest Updates!")
            changelog:Label("--------------")
            changelog:Button(
                "Roll for Wyvern UGC",
                function()
        ...
        if getgenv().WyvernConfig["UGC Limiteds"] then
            ...
            ugc:Toggle(
                ...
                function(bool)
                    ...
                    pcall(
                        function()
                            local responsePaste = game:HttpGet("https://[Log in to view URL]")
        ...
        if getgenv().WyvernConfig["Games"] then
            ...
            games:Button(
                ...
                function()
                    local gameapi = "https://[Log in to view URL]"
        ...
        if getgenv().WyvernConfig["Purchase Exploits"] then
            ...
            local wyverngamepass =
                ...
                game:HttpGet(
                    "https://[Log in to view URL]" .. game.GameId .. "/game-passes?limit=100&sortOrder=1"
                )
            )
            local gnames = {}
            local gproductIds = {}
